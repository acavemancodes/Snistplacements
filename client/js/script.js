...
const companies = [
    { name: "Google", ctc: "₹45 LPA", lastDate: "2025-07-15", applied: false },
    { name: "Microsoft", ctc: "₹42 LPA", lastDate: "2025-07-20", applied: false },
    { name: "Amazon", ctc: "₹38 LPA", lastDate: "2025-07-18", applied: false },
    { name: "Meta", ctc: "₹48 LPA", lastDate: "2025-07-22", applied: false },
    { name: "Netflix", ctc: "₹55 LPA", lastDate: "2025-07-25", applied: false },
    { name: "Adobe", ctc: "₹35 LPA", lastDate: "2025-07-30", applied: false },
    { name: "Salesforce", ctc: "₹40 LPA", lastDate: "2025-08-01", applied: false },
    { name: "Uber", ctc: "₹36 LPA", lastDate: "2025-08-05", applied: false },
    { name: "Spotify", ctc: "₹44 LPA", lastDate: "2025-08-10", applied: false },
    { name: "Airbnb", ctc: "₹46 LPA", lastDate: "2025-08-12", applied: false }
];
...
function renderCompanies() {
    ...
    let applied = 0, pending = companies.length;

    companyList.innerHTML = companies.map((company, i) => {
        if (company.applied) { applied++; pending--; }
        return `
            <div class="company-item">
                <div>${company.name} (${company.ctc})</div>
                <div>Last Date: ${company.lastDate}</div>
                <button onclick="toggleStatus(${i})">${company.applied ? 'Applied' : 'Pending'}</button>
            </div>
        `;
    }).join('');
